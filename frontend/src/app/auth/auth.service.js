...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (login) {
        ...
        params.append('client_id', 'webgabinet');
        var headers = new http_2.Headers({ 'Content-type': 'application/x-www-form-urlencoded; charset=utf-8', 'Authorization': 'Basic '
                + btoa('webgabinet:HeAltH@!23') });
