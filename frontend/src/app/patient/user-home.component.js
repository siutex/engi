...
var rx_service_1 = require("../rx/rx.service");
var UserHomeComponent = /** @class */ (function () {
    function UserHomeComponent(rxService) {
        this.rxService = rxService;
    }
    UserHomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.rxService.getRx()
            .subscribe(function (rxlist) { return _this.rxlist = rxlist; }, function (error) {
        });
    };
    UserHomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [rx_service_1.RxService])
    ], UserHomeComponent);
